...
# (str) Package name
package.name = vulcain

# (str) Package domain (needed for android/ios packaging)
package.domain = org.vulcain
...
requirements = python3,kivy,plyer,pillow,numpy,androidstorage4kivy,jnius,android,requests
...
android.presplash_color = #CAE6E5
